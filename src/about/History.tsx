...
const World = dynamic(
  () => import("../components/acerternity/globe").then((m) => m.World),
  {
    ssr: false,
  }
);
...
export function History() {
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {/* <Image
              src="https://assets.aceternity.com/pro/header.png"
              alt="header template"
              width={500}
              height={500}
              className="rounded-lg object-cover h-20 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
            />
            <Image
              src="https://assets.aceternity.com/pro/footer.png"
              alt="footer template"
              width={500}
              height={500}
              className="rounded-lg object-cover h-20 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
  ...
  return (
    <div className="flex flex-col justify-center items-center px-4 py-16">
      <h2 className="text-xl md:text-3xl font-bold mb-8">Notre Histoire</h2>
      <Timeline data={data} />
    </div>
  );
}
