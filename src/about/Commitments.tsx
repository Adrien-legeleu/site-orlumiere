...
export function Commitments() {
  ...
  return (
    <div className="space-y-12 mt-20">
      <h2 className="text-5xl text-center  font-orbitron tracking-wider text-black/80 dar:text-white/80 font-semibold">
        Nos engagements
      </h2>
      <div className="grid font-montserrat grid-cols-1 md:grid-cols-2 lg:grid-cols-4 relative z-10 py-10 max-w-7xl mx-auto">
...
const Feature = ({
  ...
  return (
    ...
    >
      {index < 4 ? (
        <div
          className={`opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-t ${gradient} dark:${gradient} to-transparent pointer-events-none`}
        />
      ) : (
        <div
          className={`opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-b ${gradient} dark:${gradient} to-transparent pointer-events-none`}
        />
      )}
