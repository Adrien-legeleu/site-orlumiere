export const Description = () => {
  return (
    <div className="h-screen w-full bg-gradient-to-b from-[#DED5CE] from-8% to-white to-45% dark:bg-black dark:bg-none">
      <div className="flex-col flex items-center justify-center max-w-[700px] h-full m-auto gap-28">
        <h2 className="text-center text-3xl tracking-wide font-orbitron font-normal">
          Joaillerie Or&Lumière, Paris
        </h2>
        <p className="text-center text-2xl text-gray-300 dark:text-gray-500 leading-loose font-montserrat">
